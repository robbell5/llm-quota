...
- [x] 04-02-PLAN.md — Add missing/stale footer hints and responsive no-wrap layouts for narrow tmux panes.
...
- [x] 06-01-PLAN.md — Add a tested `uninstall-claude-hook` command that removes only app-owned Claude setup.

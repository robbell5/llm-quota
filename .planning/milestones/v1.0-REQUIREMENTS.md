...
- [x] **TUI-01**: User can run `llm-quota` as an always-running foreground TUI.
...
- [x] **TUI-04**: User can press `q` or `Ctrl-C` to exit cleanly.
...
*Last updated: 2026-05-21 after Phase 1 retrospective verification*
